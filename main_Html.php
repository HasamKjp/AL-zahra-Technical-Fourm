...
border-radius: 50%;
 margin-left: 1%;
    ...
    <script src="script_Html.js"> </script>
...
Java is used to create computer programs.
<h3>  What is Java </h3>
...
<img class="bd-placeholder-img  img-fluid  img-thumbnail  " width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false" src="pictur/Captuore.JPG">
<h4> Example explained </h4>

<h5>Line 1: #include &lt; iostream &gt;</h5>  
...
<br>
<h5>Line 2: using namespace std </h5>  
...
<th><i>    Java Tutorial</i> </th>
           ...
           <tbody>
            <tr>
              <td>  <a href="proper_diet.html">      Java Introduction        </a> </td>  
            </tr>
            <tr>
              <td>       <a href="sport.html">     Java Syntax        </a>
              </td>  
            </tr>
            <tr>
              <td>       <a href="vitamin.html">       Java Comments         </a>
              </td>  
            </tr>
            <tr>
            <td>       <a href="page-spi.html">    Java Variables       </a> 
            </td>  
            </tr>
            <tr>
            <td>
            <a href="Malnutrition.html">     Java Data Types             </a>
            </td>  
            </tr>  <tr>
            <td>       <a href="page-spi.html">      Java Strings       </a> 
            </td>  
            </tr>   
         
            <tr>
              <td>       <a href="sport.html">     Java Constants       </a>
              </td>  
            </tr>
            <tr>
              <td>       <a href="sport.html">     Java Operators       </a>
              </td>  
            </tr>
            <tr>
              <td>       <a href="sport.html">     Java If...Else...Elseif      </a>
              </td>  
            </tr>
            <tr>
              <td>       <a href="sport.html">    Java Switch        </a>
              </td>  
            </tr>
            <tr>
              <td>       <a href="sport.html">    Java Loops        </a>
              </td>  
            </tr>  <tr>
              <td>       <a href="sport.html">   Java Functions       </a>
              </td>  
            </tr>  <tr>
              <td>       <a href="sport.html">    Java Arrays        </a>
              </td>  
            </tr>
           </tbody>
         </table>
