...
<pre>
      ...
      <img class="bd-placeholder-img  img-fluid  img-thumbnail  " width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false" src="pictur/imajm.jpg">
...
<pre>
      ...
      <table class="tab">
           <thead>
<th><i>    C++ Tutorial</i> </th>
           </thead>
           <tbody>
            <tr>
              <td>  <a href="proper_diet.html">     C++ Introduction        </a> </td>  
            </tr>
            <tr>
              <td>       <a href="sport.html">     C++ Syntax        </a>
              </td>  
            </tr>
            <tr>
              <td>       <a href="vitamin.html">       C++ Comments         </a>
              </td>  
            </tr>
            <tr>
            <td>       <a href="page-spi.html">     C++ Variables       </a> 
            </td>  
            </tr>
            <tr>
            <td>
            <a href="Malnutrition.html">      C++ Data Types             </a>
            </td>  
            </tr>  <tr>
            <td>       <a href="page-spi.html">      C++ Strings       </a> 
            </td>  
            </tr>   
         
            <tr>
              <td>       <a href="sport.html">     C++ Constants       </a>
              </td>  
            </tr>
            <tr>
              <td>       <a href="sport.html">     C++ Operators       </a>
              </td>  
            </tr>
            <tr>
              <td>       <a href="sport.html">     C++ If...Else...Elseif      </a>
              </td>  
            </tr>
            <tr>
              <td>       <a href="sport.html">     C++ Switch        </a>
              </td>  
            </tr>
            <tr>
              <td>       <a href="sport.html">    C++ Loops        </a>
              </td>  
            </tr>  <tr>
              <td>       <a href="sport.html">    C++ Functions       </a>
              </td>  
            </tr>  <tr>
              <td>       <a href="sport.html">    C++ Arrays        </a>
              </td>  
            </tr>
           </tbody>
         </table>
